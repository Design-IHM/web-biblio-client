...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-[120vh] flex items-start justify-center overflow-hidden bg-gradient-to-br from-[#1b263b] via-[#1b263b]/90 to-[#ff8c00]/70">
      ...
      <div className="container mx-auto px-6 relative z-10 pt-24 md:pt-36">
        <div className="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-20">
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            <div className="inline-block px-4 py-1 rounded-full bg-white/10 backdrop-blur-sm mb-6 transform hover:scale-105 transition-transform duration-300">
              <span className="text-white/90 font-medium text-sm">Bienvenue sur BiblioENSPY</span>
            </div>
            
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              Votre bibliothèque <span className="text-[#ff8c00] animate-pulse">numérique</span> de nouvelle génération
            </h1>
            ...
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 mb-12">
              <Link to="/bibliotheque" className="group bg-white text-[#1b263b] py-3 px-8 rounded-lg font-medium hover:bg-[#ff8c00] hover:text-white transition-all duration-300 shadow-lg hover:shadow-[#ff8c00]/30 flex items-center justify-center">
                Explorer le catalogue
                <ArrowRight className="h-5 w-5 ml-2 transform group-hover:translate-x-1 transition-transform" />
              </Link>
              <Link to="/auth" className="bg-transparent border-2 border-white text-white py-3 px-8 rounded-lg font-medium hover:bg-white hover:text-[#1b263b] transition-all duration-300 shadow-lg hover:shadow-white/30 flex items-center justify-center">
                Se connecter
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg transform hover:scale-105 transition-transform duration-300 shadow-lg">
                <div className="flex items-center justify-center sm:justify-start gap-3">
                  <Book className="text-[#ff8c00] h-8 w-8" />
                  <div>
              ...
              <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg transform hover:scale-105 transition-transform duration-300 shadow-lg">
                <div className="flex items-center justify-center sm:justify-start gap-3">
                  <Users className="text-[#ff8c00] h-8 w-8" />
                  <div>
              ...
              <div className="p-4 bg-white/10 backdrop-blur-sm rounded-lg transform hover:scale-105 transition-transform duration-300 shadow-lg">
                <div className="flex items-center justify-center sm:justify-start gap-3">
                  <Clock className="text-[#ff8c00] h-8 w-8" />
                  <div>
          ...
          <div className="w-full lg:w-1/2 mb-12 lg:mb-0">
            <div className="relative">
              ...
              >
                <div className="aspect-[4/3] bg-gradient-to-br from-white/5 to-white/30 backdrop-blur-sm p-3">
                  ...
                  <div className="w-full h-full rounded-xl overflow-hidden relative">
                    ...
                    {/* Overlay gradient */}
                    <div className="absolute inset-0 bg-gradient-to-b from-[#1b263b]/30 to-[#1b263b]/80"></div>
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-white text-2xl md:text-3xl font-bold bg-[#1b263b]/60 px-6 py-4 rounded-lg backdrop-blur-sm shadow-lg border border-white/10">
              ...
              {/* Decorative elements */}
              <div className="absolute -top-10 right-0 w-32 h-32 bg-[#ff8c00] rounded-full blur-3xl opacity-20 transform translate-x-1/2 -translate-y-1/2"></div>
              <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-[#1b263b] rounded-full blur-3xl opacity-20"></div>
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-[#1b263b]/80 text-white p-2 text-sm font-medium">
                  Bestseller
                </div>
              </div>
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-[#ff8c00]/80 text-white p-2 text-sm font-medium">
                  Nouveauté
                </div>
              </div>
